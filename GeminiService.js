...
// ✅ FIX 1: Live API expects plain model id (no "models/")
    ...
    const functionDeclarations = [
      {
        ...
        parameters: {
          // ✅ FIX 3: JSON schema types must be lowercase
          type: "object",
          properties: { 
            date: { type: "string" }, 
            barber: { type: "string" } 
    ...
    try {
      this.sessionPromise = this.ai.live.connect({
        ...
        config: {
          ...
          // ✅ FIX 2: transcription MUST be part of connect config
      ...
      // ❌ IMPORTANT: do NOT send another setup here.
      // The old code here was killing the session.
    ...
    if (this.session) {
      try {
        ...
        this.session.sendRealtimeInput([
          { mimeType: "audio/pcm;rate=16000", data: pcm16k.toString('base64') }
        ]);
      } catch (e) {
        // ✅ optional: don't swallow, log it
